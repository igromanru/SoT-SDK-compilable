...
public:
	...
	class AMurk*                                       MurkActor;                                                // 0x05C0(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
...
public:
	...
	class UVenomComponent*                             VenomComponent;                                           // 0x0400(0x0008) (Edit, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UExplosionComponent*                         ExplosionComponent;                                       // 0x0408(0x0008) (Edit, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UParticleSystem*                             BiteAttackVFX;                                            // 0x0410(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	...
	class UEnvQuery*                                   RoarEQSQuery;                                             // 0x0448(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UClass*                                      KnockbackDamagerType;                                     // 0x0450(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	struct FKnockBackInfo                              RoarKnockbackInfo;                                        // 0x0458(0x0050) (Edit)
	class UKrakenHeadAnimationInstance*                HeadAnimInstance;                                         // 0x04A8(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FVector                                     EQSQuerierLocation;                                       // 0x04B0(0x000C) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x4];                                       // 0x04BC(0x0004) MISSED OFFSET
	class UKrakenHeadHealthParamsDataAsset*            KrakenHeadHealthParams;                                   // 0x04C0(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FHeadStateChangeRequest                     HeadStateRequest;                                         // 0x04C8(0x0018) (Net)
	...
	class USceneComponent*                             Root;                                                     // 0x04E8(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	unsigned char                                      UnknownData05[0xC0];                                      // 0x04F0(0x00C0) MISSED OFFSET
	struct FName                                       BiteAttackImpactNamedPointsGroupName;                     // 0x05B0(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
